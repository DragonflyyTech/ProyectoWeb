  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="principal_p.jsp" style="margin-left: 20px;">Inicio</a>
        </li>
        ...
        <div  class="row">
            ...
            <div class="col-sm12 col-md-8 col-lg-8 col-xl-8 centrado"> 
                <div id="calendario_fondo">
                    <div class="wrapper">
                        <header>
                            <p class="mesano">Noviembre 2022</p>
                            <div class="iconos">
